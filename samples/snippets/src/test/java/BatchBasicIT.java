...
public class BatchBasicIT {
  ...
  public static void setUp()
    ...
    assertThat(stdOut.toString()).contains("Successfully created the job: " + CONTAINER_JOB_NAME);
    CreateWithScriptNoMounting.createScriptJob(PROJECT_ID, REGION, SCRIPT_JOB_NAME);
    assertThat(stdOut.toString()).contains("Successfully created the job: " + SCRIPT_JOB_NAME);
